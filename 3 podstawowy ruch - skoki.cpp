...
void KeyboardThread()
{
    while (true)
    {
        if (kbhit())
        {
            ...
            {
                mode = 1;
                std::cout << "[Key] W pressed - Stand up\n";
            }
            else if (c == 's')
            {
                mode = 2;
                std::cout << "[Key] S pressed - Stand down\n";
            }
        }
...
private:
   ...
   //double stand_down_joint_pos[12] = {0.0473455, 1.22187, -2.44375, -0.0473455, 1.22187, -2.44375, 
    //                                   0.0473455, 1.22187, -2.44375, -0.0473455, 1.22187, -2.44375};
     ...
     double stand_up_joint_pos[12] = {0, 1.2, -1.9, 0, 1.2, -1.9,        //prawy przód, lewy przód, prawy tył, lewy tył
...
void Custom::LowCmdWrite()
{
    for (int i = 0; i < 12; i++)
    {
        double* target = (mode == 1) ? stand_up_joint_pos : 
                         (mode == 2) ? stand_down_joint_pos : stand_up_joint_pos;
